...
module.exports = class ParaVFS extends ReadyResource {
      ...
      switch (op.type) {
        ...
        case OPERATION.RUN: {
          ...
          try {
            ...
            this._executing?.resolve(result)
          } catch (err) {
            this._executing?.reject(err)
          }
          this._transact()
        ...
        case OPERATION.STMT: {
          try {
            ...
            // This really shouldn't happen, ignore for now
          }
        }
        ...
        case OPERATION.FLUSH: {
          this._executing?.resolve({ changes, lastInsertRowid, errors })
          break
        }
      }
    }
  ...
  async _run(sql, named, positional) {
    ...
    try {
      ...
      return await this._executing.promise
        .then(async (result) => {
          await promise
          return result
        })
